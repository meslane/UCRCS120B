 ...
 *	Exercise Description: Keypad + LCD overwriting
 *	
 *	I acknowledge all content contained herein, excluding template 
 * 	or example code, is my own original work.
 *
 *	Demo Link: https://youtu.be/I3it8tOsfi8
 */
...
enum GetKey_States {GetKey_START, GetKey_GET, GetKey_PRESS, GetKey_WAIT};
